...
1. Read `.claude/personas/architect/AGENTS.md`
...
1. Read `.claude/personas/developer/AGENTS.md`
2. Read specialist docs as needed:
...
1. Read `.claude/personas/reviewer/AGENTS.md`
2. Read specialist docs as needed:
...
You:
1. Read `.claude/personas/architect/AGENTS.md`
2. Read `.claude/personas/architect/system-designer.md`
