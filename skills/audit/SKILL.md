...
[dev loop: code → commit]
  ...
  │   Pass: .claude/skills/audit/references/auditor-persona.md │
...
2. The persona file: `.claude/skills/audit/references/auditor-persona.md`
...
| `.claude/skills/audit/references/auditor-persona.md` | tracked | Auditor identity |
