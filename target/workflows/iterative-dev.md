...
5. Code guardrail fires automatically (Edit/Write hooks) — fix any violations
...
## Code Guardrails (Auto-enforced via hooks)
...
- `git commit` → guard-git-commit.sh (user approval required)
